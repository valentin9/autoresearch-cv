...
FONT_DIRECT_URLS = {
    ...
    # --- New additions ---
    "Inter": f"{_GH}/ofl/inter/Inter[opsz,wght].ttf",
    "Poppins": f"{_GH}/ofl/poppins/Poppins-Regular.ttf",
    "DM Sans": f"{_GH}/ofl/dmsans/DMSans[opsz,wght].ttf",
    "Rubik": f"{_GH}/ofl/rubik/Rubik[wght].ttf",
    "Work Sans": f"{_GH}/ofl/worksans/WorkSans[wght].ttf",
    "Barlow": f"{_GH}/ofl/barlow/Barlow-Regular.ttf",
    "Quicksand": f"{_GH}/ofl/quicksand/Quicksand[wght].ttf",
    "Fira Sans": f"{_GH}/ofl/firasans/FiraSans-Regular.ttf",
    "IBM Plex Sans": f"{_GH}/ofl/ibmplexsans/IBMPlexSans-Regular.ttf",
    "Titillium Web": f"{_GH}/ofl/titilliumweb/TitilliumWeb-Regular.ttf",
    "Heebo": f"{_GH}/ofl/heebo/Heebo[wght].ttf",
    "Jost": f"{_GH}/ofl/jost/Jost[wght].ttf",
    "Archivo": f"{_GH}/ofl/archivo/Archivo[wdth,wght].ttf",
    "Archivo Black": f"{_GH}/ofl/archivoblack/ArchivoBlack-Regular.ttf",
    "Karla": f"{_GH}/ofl/karla/Karla[wght].ttf",
    "Plus Jakarta Sans": f"{_GH}/ofl/plusjakartasans/PlusJakartaSans[wght].ttf",
    "Figtree": f"{_GH}/ofl/figtree/Figtree[wght].ttf",
    "Manrope": f"{_GH}/ofl/manrope/Manrope[wght].ttf",
    "Mulish": f"{_GH}/ofl/mulish/Mulish[wght].ttf",
    "Outfit": f"{_GH}/ofl/outfit/Outfit[wght].ttf",
    "Cabin": f"{_GH}/ofl/cabin/Cabin[wdth,wght].ttf",
    "Dosis": f"{_GH}/ofl/dosis/Dosis[wght].ttf",
    "Public Sans": f"{_GH}/ufl/publicsans/PublicSans[wght].ttf",
    "Assistant": f"{_GH}/ofl/assistant/Assistant[wght].ttf",
    "Space Grotesk": f"{_GH}/ofl/spacegrotesk/SpaceGrotesk[wght].ttf",
    "Red Hat Display": f"{_GH}/ofl/redhatdisplay/RedHatDisplay[wght].ttf",
    "Lexend": f"{_GH}/ofl/lexend/Lexend[wght].ttf",
    "Oxygen": f"{_GH}/ofl/oxygen/Oxygen-Regular.ttf",
    "Urbanist": f"{_GH}/ofl/urbanist/Urbanist[wght].ttf",
    "Sora": f"{_GH}/ofl/sora/Sora[wght].ttf",
    "Asap": f"{_GH}/ofl/asap/Asap[wdth,wght].ttf",
    "Abel": f"{_GH}/ofl/abel/Abel-Regular.ttf",
    "Overpass": f"{_GH}/ofl/overpass/Overpass[wght].ttf",
    "Exo 2": f"{_GH}/ofl/exo2/Exo2[wght].ttf",
    "Libre Franklin": f"{_GH}/ofl/librefranklin/LibreFranklin[wght].ttf",
    "Josefin Sans": f"{_GH}/ofl/josefinsans/JosefinSans[wght].ttf",
    "Roboto Condensed": f"{_GH}/ofl/robotocondensed/RobotoCondensed[wght].ttf",
    "Barlow Condensed": f"{_GH}/ofl/barlowcondensed/BarlowCondensed-Regular.ttf",
    "Arimo": f"{_GH}/ofl/arimo/Arimo[wght].ttf",
    "Nunito Sans": f"{_GH}/ofl/nunitosans/NunitoSans[opsz,wdth,wght].ttf",
    # Serif
    "Roboto Slab": f"{_GH}/ofl/robotoslab/RobotoSlab[wght].ttf",
    "Lora": f"{_GH}/ofl/lora/Lora[wght].ttf",
    "PT Serif": f"{_GH}/ofl/ptserif/PT_Serif-Web-Regular.ttf",
    "Noto Serif": f"{_GH}/ofl/notoserif/NotoSerif[wdth,wght].ttf",
    "Libre Baskerville": f"{_GH}/ofl/librebaskerville/LibreBaskerville-Regular.ttf",
    "EB Garamond": f"{_GH}/ofl/ebgaramond/EBGaramond[wght].ttf",
    "Bitter": f"{_GH}/ofl/bitter/Bitter[wght].ttf",
    "Cormorant Garamond": f"{_GH}/ofl/cormorantgaramond/CormorantGaramond-Regular.ttf",
    "Crimson Text": f"{_GH}/ofl/crimsontext/CrimsonText-Regular.ttf",
    "Arvo": f"{_GH}/ofl/arvo/Arvo-Regular.ttf",
    "Slabo 27px": f"{_GH}/ofl/slabo27px/Slabo27px-Regular.ttf",
    "Source Serif 4": f"{_GH}/ofl/sourceserif4/SourceSerif4[opsz,wght].ttf",
    "Instrument Serif": f"{_GH}/ofl/instrumentserif/InstrumentSerif-Regular.ttf",
    "Merriweather Sans": f"{_GH}/ofl/merriweathersans/MerriweatherSans[wght].ttf",
    # Display / decorative
    "Bebas Neue": f"{_GH}/ofl/bebasneue/BebasNeue-Regular.ttf",
    "Fjalla One": f"{_GH}/ofl/fjallaone/FjallaOne-Regular.ttf",
    "Anton": f"{_GH}/ofl/anton/Anton-Regular.ttf",
    "Orbitron": f"{_GH}/ofl/orbitron/Orbitron[wght].ttf",
    "Comfortaa": f"{_GH}/ofl/comfortaa/Comfortaa[wght].ttf",
    "Teko": f"{_GH}/ofl/teko/Teko[wght].ttf",
    "Pacifico": f"{_GH}/ofl/pacifico/Pacifico-Regular.ttf",
    "Dancing Script": f"{_GH}/ofl/dancingscript/DancingScript[wght].ttf",
    "Inconsolata": f"{_GH}/ofl/inconsolata/Inconsolata[wdth,wght].ttf",
}
